...
function buildSettingItems(config: RtkIntegrationConfig): SettingItem[] {
	return [
		...
		},
		{
			...
			description:
				"If on, read results under the global Pi skills directory (default: ~/.pi/agent/skills, respects PI_CODING_AGENT_DIR), ~/.agents/skills, .pi/skills, and ancestor .agents/skills skip read compaction",
